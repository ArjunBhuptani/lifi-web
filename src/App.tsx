import { WalletOutlined, TwitterOutlined, MediumOutlined, GithubOutlined } from '@ant-design/icons';
              ...
              <Row>
                <Col xs={2} sm={4} md={6} lg={10} xl={12}>
                  ...
                  <Menu mode="horizontal" defaultSelectedKeys={path ? [path] : []}>
                    ...
                    <Menu.Item>
                      <a href="https://docs.li.finance/for-users/user-faq" target="_blank">FAQ</a>
                    </Menu.Item>
                    <Menu.Item>
                ...
                <Col xs={2} sm={4} md={6} lg={10} xl={12}>
                  <Row justify="end">
                    <Col>
                      <a href="https://twitter.com/lifiprotocol" rel="nofollow">
                        <TwitterOutlined style={{fontSize:'20px', color: '#ffffff'}}/>
                      </a>
                    </Col>
                    <Col>
                      <a href="https://github.com/lifinance" rel="nofollow" style={{marginLeft:'15px'}}>
                        <GithubOutlined style={{fontSize:'20px', color: '#ffffff'}}  />
                      </a>
                    </Col>
                    <Col>
                      <a className="lifiSupport" href="https://discord.com/invite/G9uAbE439B" target="_blank" rel="nofollow noreferrer">Support (Discord)</a>
                    </Col>
                  </Row>
                </Col>
              </Row>
